...
import org.rabbit4j.api.utils.JacksonJson;
...
public class RabbitApiClient {
     ...
     */
    public RabbitApiClient(ApiVersion apiVersion, String hostUrl, String privateToken) {
     ...
     */
    public RabbitApiClient(ApiVersion apiVersion, String hostUrl, TokenType tokenType, String authToken) {
     ...
     * @param privateToken the private token to authenticate with
     */
    public RabbitApiClient(String hostUrl, String privateToken) {
        this(ApiVersion.r, hostUrl, TokenType.PRIVATE, privateToken, null);
    }
     ...
     * @param authToken the token to authenticate with
     */
    public RabbitApiClient(String hostUrl, TokenType tokenType, String authToken) {
        this(ApiVersion.r, hostUrl, tokenType, authToken, null);
    }
     ...
     */
    public RabbitApiClient(ApiVersion apiVersion, String hostUrl, String privateToken, String secretToken) {
     ...
     * @param secretToken use this token to validate received payloads
     */
    public RabbitApiClient(ApiVersion apiVersion, String hostUrl, TokenType tokenType, String authToken, String secretToken) {
     ...
     * @param secretToken use this token to validate received payloads
     */
    public RabbitApiClient(String hostUrl, String privateToken, String secretToken) {
        this(ApiVersion.r, hostUrl, TokenType.PRIVATE, privateToken, secretToken, null);
    }
     ...
     * @param secretToken use this token to validate received payloads
     */
    public RabbitApiClient(String hostUrl, TokenType tokenType, String authToken, String secretToken) {
        this(ApiVersion.r, hostUrl, tokenType, authToken, secretToken, null);
    }
     ...
     */
    public RabbitApiClient(String hostUrl, String privateToken, String secretToken, Map<String, Object> clientConfigProperties) {
        this(ApiVersion.r, hostUrl, TokenType.PRIVATE, privateToken, secretToken, clientConfigProperties);
    }
     ...
     * @param clientConfigProperties the properties given to Jersey's clientconfig
     */
    public RabbitApiClient(ApiVersion apiVersion, String hostUrl, String privateToken, String secretToken, Map<String, Object> clientConfigProperties) {
     ...
     * @param clientConfigProperties the properties given to Jersey's clientconfig
     */
    public RabbitApiClient(ApiVersion apiVersion, String hostUrl, TokenType tokenType, String authToken, String secretToken, Map<String, Object> clientConfigProperties) {
    ...
    protected Response post(Form formData, URL url) {
        if (formData instanceof RabbitApiForm) {
