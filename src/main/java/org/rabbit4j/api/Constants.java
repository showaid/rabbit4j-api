...
import org.rabbit4j.api.utils.JacksonJsonEnumHelper;
...
public interface Constants {
    ...
    public enum ArchiveFormat {
        ...
        public static ArchiveFormat forValue(String value) throws RabbitApiException {
            ...
            throw new RabbitApiException("Invalid format! Options are tar.gz, tar.bz2, tbz, tbz2, tb2, bz2, tar, and zip.");
        }
