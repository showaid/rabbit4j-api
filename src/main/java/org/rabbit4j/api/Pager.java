...
public class Pager<T> implements Iterator<List<T>>, Constants {
     ...
     * @throws RabbitApiException if any error occurs
     */
    Pager(AbstractApi api, Class<T> type, int itemsPerPage, MultivaluedMap<String, String> queryParams, Object... pathArgs) throws RabbitApiException {
        ...
        if (queryParams == null) {
            queryParams = new RabbitApiForm().withParam(PER_PAGE_PARAM, itemsPerPage).asMap();
        } else {
        ...
        try {
            ...
            throw new RabbitApiException(e);
        }

        if (currentItems == null) {
            throw new RabbitApiException("Invalid response from from GitLab server");
        }
     ...
     * @throws RabbitApiException if any error occurs
     */
    private String getHeaderValue(Response response, String key) throws RabbitApiException {
     ...
     * @throws RabbitApiException if any error occurs
     */
    private int getIntHeaderValue(Response response, String key) throws RabbitApiException {
        ...
        try {
            ...
            throw new RabbitApiException("Invalid '" + key + "' header value (" + value + ") from server");
        }
    }
     ...
     * @throws RuntimeException if a GitLab API error occurs, will contain a wrapped RabbitApiException with the details of the error
     */
    @Override
    public List<T> next() {
     ...
     * @throws RabbitApiException if any error occurs
     */
    public List<T> first() throws RabbitApiException {
        return (page(1));
    }
     ...
     * @throws RabbitApiException if any error occurs
     */
    public List<T> last() throws RabbitApiException {

        if (kaminariNextPage != 0) {
            throw new RabbitApiException("Kaminari count limit exceeded, unable to fetch last page");
        }
     ...
     * @throws RabbitApiException if any error occurs
     */
    public List<T> previous() throws RabbitApiException {
        return (page(currentPage - 1));
    }
     ...
     * @throws RabbitApiException if any error occurs
     */
    public List<T> current() throws RabbitApiException {
    ...
    public List<T> page(int pageNumber) {
        ...
        } catch (RabbitApiException | IOException e) {
     ...
     * @throws RabbitApiException if any error occurs
     */
    public List<T> all() throws RabbitApiException {
     ...
     * @throws RabbitApiException if any other error occurs
     */
    public Stream<T> stream() throws RabbitApiException, IllegalStateException {
