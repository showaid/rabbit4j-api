...
import org.rabbit4j.api.models.AccessLevel;
import org.rabbit4j.api.models.Variable;
import org.rabbit4j.api.utils.ISO8601;

/**
 * This class extends the standard JAX-RS Form class to make it fluent.
 */
public class RabbitApiForm extends Form {

    public RabbitApiForm() {
        super();
    }

    public RabbitApiForm(MultivaluedHashMap<String, String> map) {
        super(map);
    }
     ...
     */
    public RabbitApiForm(int page, int perPage) {
        super();
     ...
     */
    public RabbitApiForm withParam(String name, Object value) throws IllegalArgumentException {
     ...
     * @return this GitLabAPiForm instance
     */
    public RabbitApiForm withParam(String name, Date date) throws IllegalArgumentException {
     ...
     */
    public RabbitApiForm withParam(String name, Date date, boolean required) throws IllegalArgumentException {
     ...
     * @return this GitLabAPiForm instance
     */
    public RabbitApiForm withParam(String name, AccessLevel level) throws IllegalArgumentException {
     ...
     * @throws IllegalArgumentException if a required parameter is null or empty
     */
    public RabbitApiForm withParam(String name, AccessLevel level, boolean required) throws IllegalArgumentException {
     ...
     * @return this GitLabAPiForm instance
     */
    public <T> RabbitApiForm withParam(String name, List<T> values) {
     ...
     * @throws IllegalArgumentException if a required parameter is null or empty
     */
    public <T> RabbitApiForm withParam(String name, List<T> values, boolean required) throws IllegalArgumentException {
     ...
     * @throws IllegalArgumentException if a required parameter is null or empty
     */
    public RabbitApiForm withParam(String name, Map<String, ?> variables, boolean required) throws IllegalArgumentException {
     ...
     * @throws IllegalArgumentException if a required parameter is null or empty
     */
    public RabbitApiForm withParam(String name, Object value, boolean required) throws IllegalArgumentException {
     ...
     * @return this GitLabAPiForm instance
     */
    public RabbitApiForm withParam(List<Variable> variables) {
