...
public class RabbitApiException extends Exception {
     ...
     */
    public RabbitApiException(String message) {
        super(message);
     ...
     */
    public RabbitApiException(String message, int httpStatus) {
        super(message);
        this.message = message;
     ...
     */
    public RabbitApiException(Response response) {
     ...
     */
    public RabbitApiException(Exception e) {
        super(e);
    ...
    public boolean equals(Object obj) {
        ...
        RabbitApiException other = (RabbitApiException) obj;
